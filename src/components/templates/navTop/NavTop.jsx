...
const NavTop = () => {
  ...
  return (
    <>
      <div className={`w-full z-50 top-0 flex justify-between items-center transition-all duration-300 ease-in-out ${isSticky ? "sticky h-20 p-5 shadow-xs bg-slate-900" : "h-20 px-12 shadow-xs bg-slate-800"}`}>
        <BrandName />
